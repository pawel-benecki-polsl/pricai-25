...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', type=str, nargs='+', default=[os.path.join('train', 'traditional'), os.path.join('train', 'cnn'), os.path.join('train', 'mix')], help='datasets to train on: [train/traditional],[train/cnn],[train/mix],[val/traditional],[val/cnn],[val/color],[val/deblur],[val/frameinterp],[val/superres]')
    ...
    summary(trainer.net, [(3, 100, 100), (3, 100, 100)])
